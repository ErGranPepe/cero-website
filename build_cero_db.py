...
def get_db():
    ...
    db["DOC-004"] = {
        ...
        "subtitle": "Estructura de la Organización y Cadencia de Trabajo Semanal/Mensual",
        "author": "Dirección Estratégica CERO",
        "status": "APROBADO",
        "version": "v16.0",
        "date": "15.07.2026",
        "sections": [
            ["1. Cadencia de Trabajo Semanal y Gestión del Scrum",
             "Para mantener el ritmo y el alineamiento de la comunidad abierta sin fatigar a los voluntarios, CERO opera con Sprints bisemanales (sprints de 14 días) gestionados en Discord y coordinados a través de tableros Kanban públicos en GitHub. Cada sprint comienza el lunes a las 20:00 con una planificación rápida de 15 minutos en Discord de voz (Sprint Planning) y concluye con una sesión de Review y Demo los domingos alternos. Las tareas se desglosan en tarjetas Kanban accesibles, priorizando micro-retos de 2 horas. Esto asegura que cada miembro de la comunidad pueda aportar valor de inmediato y ver reflejado su esfuerzo en las actualizaciones viales de YouTube, las cuales coinciden con el cierre de cada sprint."],
            ["2. Reunión de Voz de Discord y Canales Operativos",
             "La comunicación se organiza en servidores estructurados con permisos reactivos. Se definen tres niveles de acceso:\n"
             "• #general-chat: Para discusiones conceptuales abiertas, debates de vlogs y anuncios generales de operaciones.\n"
             "• #micro-retos: Canal clave de dopaminización donde se publican retos rápidos de diseño CAD y simulación, monitorizados por mentores.\n"
             "• #core-team-voice: Canal privado de voz con grabaciones automáticas de reuniones de desarrollo técnico.\n\n"
             "Cada domingo de cierre de Sprint se realiza una Asamblea General en Discord de voz a las 18:00 (abierta a mecenas de Patreon y colaboradores), donde se repasan los avances del CAD en directo y se aprueba la fusión de ramas en la rama principal de Onshape."],
            ["3. Matriz de Responsabilidades de Gobernanza (RACI)",
             "Para garantizar la agilidad operativa, las decisiones se rigen por una matriz RACI estructurada: el Director de Proyecto asume la responsabilidad final (Accountable) de la homologación y de la S.L.; la Comisión Técnica (ingenieros de la comunidad) es Responsable de la ejecución de planos en Onshape y análisis FEA; los Asesores Legales son Consultados para los pactos de socios y cesiones de IP; y la comunidad en general es Informada a través de los vlogs y el servidor general de Discord."]
        ],
        "table": {
            "cols": [120, 60, 60, 60, 60, 84],
            "data": [
                ["Decisión / Tarea", "Director", "Comisión", "Asesores", "Mecenas", "Comunidad"],
                ["Aprobación CAD", "A", "R", "C", "I", "I"],
                ["Homologación HIV", "A", "C", "C", "I", "I"],
                ["Lanzamiento Patreon", "A", "I", "C", "R", "I"],
    ...
    db["DOC-005"] = {
        ...
        "subtitle": "Ficha de Especificaciones Técnicas y Requisitos de Homologación Individual",
        "author": "Ingeniería y Producto CERO",
        "status": "APROBADO",
        "version": "v16.0",
        "date": "15.07.2026",
        "sections": [
    ...
    db["DOC-008"] = {
        ...
        "subtitle": "Plan de Corte, Soldadura TIG y Protocolo de Seguridad Eléctrica",
        "author": "Taller y Fabricación CERO",
        "status": "APROBADO",
        "version": "v16.0",
        "date": "15.07.2026",
        "sections": [
    ...
    db["DOC-012"] = {
        ...
        "subtitle": "Manual de Incorporación y Tareas de Dopamina Rápida",
        "author": "Recursos Humanos y Comunidad CERO",
        "status": "APROBADO",
        "version": "v16.0",
        "date": "15.07.2026",
        "sections": [
    ...
    db["DOC-020"] = {
        ...
        "date": "15.07.2026",
        "sections": [
            ["1. Constitución de Asociación Inicial y Ventajas Fiscales",
             "Para operar legalmente con 0€ y gestionar suscripciones Patreon y donaciones, se constituye la 'Asociación de Ingeniería de Código Abierto CERO' en España bajo la Ley Orgánica 1/2002. Esta forma jurídica está exenta de IVA en sus cuotas asociativas (Patreon) bajo el Artículo 20.Uno.14º de la Ley del IVA (exención de actividades socioculturales y de desarrollo de ingeniería de código abierto). Asimismo, permite la firma de contratos de permuta de servicios publicitarios (canje publicitario o barter) de forma legal bajo el Artículo 1538 del Código Civil, posibilitando recibir materiales (tubos de cromoly, consumibles de soldadura, espacio físico de garaje) a cambio de espacio publicitario en la serie de vlogs de YouTube de CERO sin devengo de IVA ni facturación comercial monetaria en la fase inicial de bootstrapping. Esta estructura protege patrimonialmente a los fundadores ante responsabilidades civiles en las fases virtuales del proyecto.\n\n"
             "La asociación abrirá una cuenta bancaria dedicada donde se depositarán todas las cuotas de Patreon y donaciones de patrocinadores, gestionándose con total transparencia pública en las deudas y auditorías contables mensuales."],
            ["2. Pivotación Futura a Sociedad Limitada (S.L.)",
             "En el Mes 18, coincidiendo con la congelación del diseño CAD y antes de iniciar los ensayos físicos en pista de homologación, se constituirá 'CERO MOTOR S.L.' conforme a la Ley de Sociedades de Capital (LSC). Los activos intangibles acumulados por la Asociación (planos Onshape CAD V2, simulaciones FEA de torsión y CFD de aerodinámica, y la base de datos de 10.000+ miembros de la comunidad) se transferirán a la S.L. mediante una aportación no dineraria de activos intangibles, regulada bajo el Artículo 63 de la LSC. El valor de dicha aportación será unánimemente certificado y garantizado por los socios fundadores bajo responsabilidad solidaria (Artículo 73 LSC), evitando costes elevados de auditoría externa y facilitando la inyección inmediata de capital semilla en la S.L."],
            ["3. Modelo de Doble Entidad y Acuerdo de Nivel de Servicio (SLA)",
             "El ecosistema CERO operará mediante una estructura dual. La Asociación retendrá la gestión de la comunidad abierta de Discord, los canales de marketing, los vlogs de YouTube y la marca open-source, garantizando que el núcleo del proyecto siga perteneciendo a internet. La S.L. será la entidad encargada de la homologación individual de vehículos, la compra del chasis, la producción física de kits de montaje comercial y la firma de rondas de inversión. Ambas entidades estarán vinculadas por un Acuerdo de Nivel de Servicio (SLA) y licencia de marca. La S.L. pagará un canon anual de licencia de marca a la Asociación (financiando eventos comunitarios y servidores de Discord) y, a cambio, la Asociación cederá en exclusiva los derechos de explotación comercial y fabricación de los planos CAD desarrollados por la comunidad."]
        ]
    }
    ...
    db["DOC-021"] = {
        ...
        "date": "15.07.2026",
        "sections": [
            ["1. Modelo Financiero de Caja y Bootstrapping",
             "El modelo financiero inicial de CERO se basa en un crecimiento orgánico autosostenido (bootstrapping puro) para evitar el endeudamiento de los fundadores durante las fases de diseño virtual (Mes 1-12). La única fuente de ingresos monetarios recurrentes es el programa de mecenazgo de Patreon, estructurado en tres niveles de aportación:\n"
             "• Nivel Boceto (2.99 €/mes): Acceso al canal general de Discord y votaciones conceptuales (Conversión esperada: 60%).\n"
             "• Nivel CAD (5.99 €/mes): Acceso de lectura directa a los archivos Onshape y hojas de cálculo de diseño cinemático (Conversión: 30%).\n"
             "• Nivel Core (19.99 €/mes): Derecho a proponer fusiones (Pull Requests) de CAD, participar en llamadas semanales de voz del Core Team y acceso al Data Room financiero (Conversión: 10%).\n\n"
             "Toda la facturación se gestiona a través de la cuenta de la Asociación CERO, con exención de IVA en base a actividades no lucrativas, asegurando una retención neta del 95% (descontando un 5% de comisiones de procesamiento de Stripe y conversión de divisas)."],
            ["2. Costes Operativos de Taller y Consumibles (Fase de Fabricación)",
             "Durante la Fase de Taller (Mes 13-24), los costes operativos mensuales fijos se limitan a 250 € (seguro de responsabilidad civil y mantenimiento básico de herramientas). El resto de costes son variables asociados a la compra de material y soldadura:\n"
             "• Consumo Eléctrico de Soldadura TIG: Límite de potencia contratada de 5.5 kW en Móstoles. Estimamos un coste eléctrico variable de 80 € mensuales para sesiones intensivas de soldadura de 20 horas al mes.\n"
             "• Gas Argón y Consumibles: Se consumirán aproximadamente 3 botellas de 50L de Argón puro al 99.9% (120 €/unidad) para la soldadura con purga interna (back-purging), sumando 360 €.\n"
             "• Mesa Jig y Accesorios: 450 € para perfiles rectangulares de acero dulce y abrazaderas ajustables de fijación geométrica."],
            ["3. Presupuesto y Tasas de Homologación Vial Individual (HIV)",
             "La fase más intensiva en capital es la Homologación Individual de Vehículos (Mes 25-28) bajo el Real Decreto 750/2010. El presupuesto detallado es:\n"
             "• Informe de Conformidad (Servicio Técnico oficial IDIADA/INTA): 2.500 €.\n"
             "• Ensayos Dinámicos de Pista (Pruebas de eficiencia de frenado R13-H y nivel de ruido R51): 1.800 €.\n"
             "• Certificación de Compatibilidad Electromagnética (UNECE R10): 1.200 €.\n"
             "• Ficha Reducida y tasas de la estación de ITV física: 650 €.\n"
             "• Gastos imprevistos de re-ensayo técnico (Buffer de contingencia): 2.000 €."],
            ["4. Proyecciones de Ingresos a 3 Años (Venta de Planos y Kits de Chasis)",
             "Tras la homologación exitosa del primer prototipo (Mes 28), CERO S.L. iniciará la comercialización bajo dos vías de ingresos:\n"
             "1. Venta del Dossier Técnico de Fabricación Homologable: 99 € (plano Onshape validado, manual de soldadura paso a paso, lista de compras de tubos optimizada y plantilla de dossier IDIADA para réplica local). Proyección Año 1: 500 descargas viales (49.500 € de facturación bruta).\n"
             "2. Venta de Kits de Chasis Pre-cortados y Biselados (Flat-Pack): 2.490 € (tubos de acero cromoly 4130 biselados con notcher de precisión listos para soldar, planos en papel y soportes de motor cortados por láser). Margen bruto estimado: 42% (Coste de material y corte: 1.450 € por kit). Proyección Año 1: 50 kits vendidos (124.500 € de facturación).\n\n"
             "Esto sitúa la facturación proyectada del Año 1 comercial en 174.000 € con un margen EBITDA del 31%, permitiendo amortizar la inversión inicial de los inversores semilla en menos de 18 meses."]
        ],
    ...
    db["DOC-022"] = {
        ...
        "sections": [
            ["1. Organización del Repositorio de Inversores",
             "El Data Room de CERO está estructurado bajo estándares de Venture Capital para facilitar la auditoría de Due Diligence. El repositorio en la nube se divide en cuatro carpetas maestras:\n"
             "1. Corporativo y Legal: Estatutos de la S.L., borrador de Pacto de Socios (DOC-024), contratos de cesión de IP de todos los ingenieros (DOC-023), y el acuerdo SLA dual (DOC-020).\n"
             "2. Financiero: Modelo de caja, runway proyectado a 24 meses (DOC-021) y conciliación de donaciones Patreon.\n"
             "3. Técnico e Ingeniería: Archivos CAD exportados, simulaciones de fatiga del chasis y flujogramas de homologación ITV.\n"
             "4. Marketing: Métricas mensuales de conversión de redes y tasa de retención de Patreon.\n\n"
            ...
            ["2. Activos Intangibles del Proyecto y Valoración",
             "La valoración premoney de CERO en la ronda semilla se sustenta en tres pilares intangibles:\n"
             "• Propiedad Intelectual Industrial: Licencia de explotación exclusiva de los planos CAD del chasis en Onshape, validados mediante FEA.\n"
             "• Base de Clientes y Comunidad: Lista de correos y miembros activos de Discord (5.000+) listos para el lanzamiento de kits de chasis.\n"
             "• Marca Registrada: El registro nacional y europeo de la marca mixta 'CERO' ante la OEPM y la EUIPO, protegiendo las clases de automoción y software abierto."],
            ["3. Estructura de la Ronda Semilla (Seed Round)",
             "Se proyecta levantar una ronda semilla de **150.000 €** en el Mes 18 de desarrollo:\n"
             "• Instrumento: Nota convertible o ampliación de capital directa con prima de emisión.\n"
             "• Destino de Fondos: 35% Adquisición final de baterías e inversores, 30% Tasas de laboratorios oficiales IDIADA/INTA y pruebas viales, 25% Alquiler del taller de montaje definitivo, 10% Gastos de constitución legal e impuestos.\n"
             "• Derechos de Inversores: Acceso a un asiento en el Consejo de Administración (formado por 2 fundadores y 1 inversor principal) y cláusulas de arrastre/acompañamiento para la salida estratégica."]
        ],
        "image": "kpi_projections.png"
    }
    ...
    db["DOC-023"] = {
        ...
        "sections": [
            ["1. Estrategia de Código Abierto CC BY-NC 4.0",
             "Todos los planos de diseño CAD, especificaciones de componentes y código de control de CERO se publican bajo la licencia de código abierto Creative Commons Reconocimiento-NoComercial 4.0 Internacional (CC BY-NC 4.0). Esta licencia permite que aficionados y estudiantes descarguen, modifiquen y fabriquen el coche de manera individual para su uso recreativo o de investigación. Sin embargo, prohíbe explícitamente el uso comercial de los diseños, incluyendo: la venta de chasis soldados de forma industrial, la comercialización de kits pre-fabricados de chasis de CERO, o la explotación de los planos para crear una marca de vehículos comerciales competidora sin un acuerdo formal con CERO S.L. Cualquier uso comercial requiere la firma de una licencia comercial exclusiva de pago, garantizando la monetización del proyecto para el sostenimiento financiero a largo plazo."],
            ["2. Contratos de Cesión de IP de Colaboradores (CLA)",
             "Para asegurar que el proyecto no se bloquee legalmente debido a reclamaciones de derechos de autor de antiguos colaboradores, es obligatorio que todo ingeniero firme digitalmente un Acuerdo de Licencia de Contribuidor (CLA) antes de recibir permisos de edición en Onshape o de realizar un Pull Request en GitHub. Bajo este acuerdo, el colaborador cede irrevocablemente todos los derechos patrimoniales sobre su diseño a la Asociación CERO, conservando los derechos morales de atribución. Esta cadena de custodia de la propiedad intelectual es auditada periódicamente y se encuentra a disposición de los inversores en el Data Room."],
            ["3. Defensa de Marca y Registro de Patentes",
             "La marca gráfica y fonética 'CERO MOTOR CO.' y sus variantes serán registradas en la Oficina Española de Patentes y Marcas (OEPM) y en la EUIPO bajo las clases de Niza correspondientes a vehículos eléctricos terrestres y software de diseño. Si un tercero realiza un fork malicioso comercial del repositorio de chasis de CERO, se ejercerán acciones legales por infracción de marca registrada. Quedan excluidas de patentes las geometrías de chasis para asegurar su carácter libre, pero se patentarán los algoritmos de control dinámico desarrollados por el Core Team, licenciándose en abierto únicamente para uso no comercial."]
        ]
    }
    ...
    db["DOC-024"] = {
        ...
        "sections": [
            ["1. Cláusulas de Pacto de Socios de CERO S.L.",
             ...
             "• Cláusula de Arrastre (Drag-Along): Si un comprador ofrece adquirir el 100% de CERO, los socios mayoritarios pueden obligar a los minoritarios a vender sus acciones al mismo precio con un umbral de aprobación del 66%.\n"
             "• Derecho de Adquisición Preferente: Los fundadores y socios activos tienen prioridad de compra ante la salida de algún colaborador."],
            ["2. Esquema de Vesting y Cláusulas de Leaver (Good/Bad)",
             "El reparto de stock options y participaciones de CERO S.L. para colaboradores Core está sujeto a un calendario de vesting de **4 años con un cliff de 12 meses** (el devengo se inicia mensualmente al transcurrir el primer año de permanencia).\n"
             "• Good Leaver: Si un miembro abandona el proyecto por causas justificadas (salud, incapacidad, o despido improcedente), conservará el porcentaje ya consolidado (vested), cancelándose el no consolidado.\n"
             "• Bad Leaver: Si el miembro es despedido de forma procedente, comete infracciones de propiedad intelectual, trabaja para un competidor directo o abandona voluntariamente antes del cliff de 12 meses, perderá todo derecho acumulado y las participaciones serán recompradas por la S.L. a valor nominal de 0.01 € por acción."],
            ["3. Gobernanza Corporativa y Toma de Decisiones",
             "La junta general de socios de CERO S.L. se regirá por mayorías simples para decisiones ordinarias, pero requerirá una **mayoría cualificada del 75%** para asuntos trascendentales:\n"
             "• Modificación del carácter open-source del diseño CAD fundamental.\n"
             "• Fusión, adquisición, venta de la propiedad intelectual o liquidación de la compañía.\n"
             "• Emisión de nuevas clases de acciones o deuda superior a 50.000 €.\n"
             "• Aprobación del plan anual de compensación a fundadores.\n"
             "Esto garantiza que el Core Team y los inversores semilla tengan control de veto mutuo sobre el rumbo estratégico de la empresa."]
        ]
    }
    ...
    db["DOC-031"] = {
        ...
        "subtitle": "Librería de Guiones de Vídeo para YouTube y TikTok",
        "author": "Contenido CERO",
        "status": "APROBADO",
        "version": "v16.0",
        "date": "15.07.2026",
        "sections": [
    ...
    db["DOC-040"] = {
        ...
        "subtitle": "Guía Práctica de Compra, Logística de Baterías y Almacenamiento Seguro",
        "author": "Logística CERO",
        "status": "APROBADO",
        "version": "v16.0",
        "date": "15.07.2026",
        "sections": [
    ...
    db["DOC-042"] = {
        ...
        "subtitle": "Guiones Telefónicos de Patrocinio y Plantilla de Contrato Barter",
        "author": "Fundadores de CERO",
        "status": "APROBADO",
        "version": "v16.0",
        "date": "15.07.2026",

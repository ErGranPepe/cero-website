...
def get_db():
    ...
    db["DOC-021"] = {
        ...
        "sections": [
            ...
            ["3. Runway de Inversión y Tasa de Gasto (Burn Rate) Proyectada", "A continuación se ilustra la simulación de flujo de caja y la tasa de consumo de capital (runway) proyectada tras asegurar la ronda de financiación pre-semilla de 50.000€:"],

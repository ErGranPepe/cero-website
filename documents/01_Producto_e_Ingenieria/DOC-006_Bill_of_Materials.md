...
**Lista de Materiales Detallada (BOM), Proveedores e Inversión de Sourcing**
...
Esta Lista de Materiales (BOM) detalla de manera minuciosa cada elemento físico necesario para el montaje final de CERO. Para mantener el modelo estratégico de bootstrapping de 0€, el aprovisionamiento se gestiona mediante tres fuentes:
...
| --- | --- | --- | --- |
| Motor Suzuki GSX-R | Usado K6-K7, cableado y ECU | 1.200 € | Compra Patreon Mes 12 |
| Tubos Acero 4130 | 25.4mm x 2.0mm (50 metros) | 0 € | Patrocinio de Metalúrgica |
| Doble Pinza Freno | Brembo / Wilwood y discos | 900 € | Compra Patreon |
| Amortiguadores | Coilovers de moto ajustables | 0 € | Patrocinio Marca |
| Escape y Catalizador | Convertidor Euro 6 y silenciador | 1.200 € | Compra Patreon |
